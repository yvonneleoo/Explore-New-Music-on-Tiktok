...
if __name__ == '__main__':
    ...
    ## track
    track = cmi.clean_sub_df(self, 'track', sub_info_type='song')

    ## artist
    artist = cmi.clean_sub_df(self, 'track', sub_info_type='artist')

    ## genres
    genres = cmi.clean_sub_df(self, 'genres', sub_info_type=None)
    ...
    cmi.write_parquet_s3(text_df, route='music-hame', partition='name_key_1')
